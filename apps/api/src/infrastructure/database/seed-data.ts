...
const harbourRisk: RiskSummary = {
  ...
  confidence: 0.84,
  flags: [
    'Single-asset concentration in Canary Wharf',
    'Lease expiry cluster in 2029',
  ],
  dimensions: [
    {
      ...
      score: 18,
      rationale:
        '100% legal title is documented through the SPA and land registry extract.',
    },
    {
      ...
      score: 22,
      rationale:
        'Title, SPA, valuation, insurance and KYC packs are present and current.',
    },
    {
      ...
      score: 41,
      rationale:
        'Occupancy is 94% but three major leases expire within 36 months.',
    },
    {
      key: 'jurisdiction',
      ...
      score: 28,
      rationale:
        'England & Wales title is clean; no material litigation disclosed.',
    },
  ],
};
...
const harbourDna: AssetDnaEnvelope = {
  ...
  facts: [
    ...
    fact(
      ...
      'legal_ownership',
      'Legal ownership',
      '100% Harbourview Tower SPV Limited',
      0.97,
      'doc_hv_title',
    ),
    fact(
    ...
    fact('f_hv_occ', 'occupancy', 'Occupancy', '94%', 0.85, 'doc_hv_val', {
      numericValue: 94,
      unit: '%',
    }),
    fact('f_hv_walt', 'walt', 'WALT', '7.4 years', 0.84, 'doc_hv_val', {
      numericValue: 7.4,
      unit: 'years',
    }),
    fact(
      ...
      'location',
      'Location',
      '14 Harbourview, Canary Wharf, London E14 5AB',
      0.95,
      'doc_hv_title',
    ),
  ],
  ...
  timeline: [
    event(
      ...
      'Meridian acquired 100% of Harbourview Tower SPV Limited for GBP 86.4m.',
      'OWNERSHIP',
      0.96,
      'doc_hv_spa',
    ),
    event(
      ...
      '2025-09-01',
      'Insurance renewed',
      'All-risks property policy renewed with a GBP 95m declared value.',
      'LEGAL',
      0.82,
      'doc_hv_ins',
    ),
    event(
      ...
      'Knightvale valued the asset at GBP 92.8m on an income capitalization basis.',
      'VALUATION',
      0.9,
      'doc_hv_val',
    ),
...
const aureliaValuation: ValuationSummary = {
  ...
  confidence: 0.81,
  notes: [
    'Fund NAV is USD 48.25m after ECL of 1.8%.',
    'Two watchlist names drive most residual uncertainty.',
  ],
};
...
const aureliaRisk: RiskSummary = {
  ...
  confidence: 0.8,
  flags: [
    'Watchlist credits in healthcare services',
  ...
  dimensions: [
    {
      ...
      score: 52,
      rationale: 'Weighted average internal rating is BB- with 8% watchlist.',
    },
    {
      key: 'document_coverage',
      label: 'Document coverage',
      score: 31,
      rationale: 'LPA, latest NAV pack and KYC are on file.',
    },
    {
      key: 'liquidity',
      label: 'Liquidity',
      score: 58,
      rationale: 'Closed-end fund with 2029 harvest window.',
    },
    {
      key: 'governance',
      label: 'Governance',
      score: 29,
      rationale: 'Independent GP with standard LPAC rights.',
    },
  ],
};
...
const aureliaDna: AssetDnaEnvelope = {
  ...
  facts: [
    fact('f_au_nav', 'nav', 'Latest NAV', 'USD 48,250,000', 0.9, 'doc_au_nav', {
      numericValue: 48_250_000,
      currency: 'USD',
    }),
    fact(
      'f_au_commit',
      ...
      0.94,
      'doc_au_lpa',
      { numericValue: 50_000_000, currency: 'USD' },
    ),
    fact(
      'f_au_called',
      'called_capital',
  ...
  timeline: [
    event(
      ...
      '2023-11-02',
      'Final close',
      'Fund III reached final close at USD 1.1bn.',
      'LEGAL',
      0.9,
      'doc_au_lpa',
    ),
    event(
      ...
      '2026-06-30',
      'Q2 NAV issued',
      'Meridian commitment marked at USD 48.25m.',
      'VALUATION',
      0.88,
      'doc_au_nav',
    ),
...
const soleilValuation: ValuationSummary = {
  ...
  confidence: 0.74,
  notes: [
    'Production vintage volatility remains the key valuation swing factor.',
  ],
};
...
const soleilRisk: RiskSummary = {
  ...
  dimensions: [
    {
      key: 'title',
      label: 'Title & appellation',
      score: 21,
      rationale: 'AOC Saint-Émilion title is registered and unencumbered.',
    },
    {
      key: 'climate',
      label: 'Climate & production',
      score: 57,
      rationale: 'Two weaker vintages in five years affect cash yield.',
    },
    {
      key: 'document_coverage',
      label: 'Document coverage',
      score: 33,
      rationale: 'Deed, valuation and insurance are present.',
    },
  ],
};
...
const soleilDna: AssetDnaEnvelope = {
  ...
  facts: [
    fact(
      ...
      0.8,
      'doc_so_val',
      { numericValue: 18_600_000, currency: 'EUR' },
    ),
    fact(
      'f_so_ha',
      'hectares',
      ...
      0.92,
      'doc_so_deed',
      { numericValue: 42, unit: 'ha' },
    ),
    fact(
      'f_so_own',
      'legal_ownership',
      'Legal ownership',
      '100% Soleil Estate SARL',
      0.94,
      'doc_so_deed',
    ),
  ],
  ...
  timeline: [
    event(
      ...
      '2022-09-08',
      'Estate acquired',
      'Meridian purchased Soleil Estate SARL including 42 hectares of AOC vines.',
      'OWNERSHIP',
      0.93,
      'doc_so_deed',
    ),
    event(
      ...
      '2026-05-15',
      'Appraisal update',
      'Rural assets specialist marked the estate at EUR 18.6m.',
      'VALUATION',
      0.8,
      'doc_so_val',
    ),
...
const nimbusRisk: RiskSummary = {
  ...
  confidence: 0.79,
  flags: [
    'Residual value sensitivity to utilization',
    'Operator jurisdiction complexity',
  ],
  dimensions: [
    {
      key: 'airworthiness',
      label: 'Airworthiness',
      score: 24,
      rationale: 'Current certificate and maintenance records are complete.',
    },
    {
      key: 'residual',
      label: 'Residual value',
      score: 49,
      rationale: 'Large-cabin residuals remain cyclical.',
    },
    {
      key: 'document_coverage',
      label: 'Document coverage',
      score: 27,
      rationale: 'Bill of sale, insurance and valuation on file.',
    },
  ],
};
...
const nimbusDna: AssetDnaEnvelope = {
  ...
  facts: [
    fact(
      ...
      0.84,
      'doc_ni_val',
      { numericValue: 31_400_000, currency: 'USD' },
    ),
    fact(
      'f_ni_sn',
      'serial_number',
  ...
  timeline: [
    event(
      ...
      '2024-01-19',
      'Aircraft acquired',
      'Nimbus Aviation IOM Ltd completed purchase of G650-6231.',
      'OWNERSHIP',
      0.95,
      'doc_ni_sale',
    ),
    event(
      ...
      '2026-04-20',
      'Desktop appraisal',
      'Aviation residual specialist marked the aircraft at USD 31.4m.',
      'VALUATION',
      0.84,
      'doc_ni_val',
    ),
...
const klineValuation: ValuationSummary = {
  ...
  confidence: 0.71,
  notes: [
    'Market for 1960s color-field works remains deep but price dispersion is wide.',
  ],
};
...
const klineRisk: RiskSummary = {
  ...
  confidence: 0.7,
  flags: [
    'Authenticity / provenance sensitivity',
    'Insurance sub-limit on transit',
  ],
  dimensions: [
    {
      key: 'provenance',
      ...
      score: 38,
      rationale:
        'Gallery invoices and exhibition history are complete from 1998 onward.',
    },
    {
      key: 'condition',
      label: 'Condition',
      score: 27,
      rationale: 'Latest condition report is excellent with no restoration.',
    },
    {
      key: 'liquidity',
      label: 'Liquidity',
      score: 62,
      rationale: 'Sale would likely require a 6–9 month consignment window.',
    },
  ],
};
...
const klineDna: AssetDnaEnvelope = {
  ...
  facts: [
    fact(
      ...
      0.72,
      'doc_kl_cond',
      { numericValue: 6_750_000, currency: 'USD' },
    ),
    fact(
      'f_kl_artist',
      'artist',
  ...
  timeline: [
    event(
      ...
      'Purchased from Westline Modern for USD 4.15m.',
      'OWNERSHIP',
      0.9,
      'doc_kl_invoice',
    ),
    event(
      't_kl_cond',
      '2026-03-12',
      'Condition and value update',
      'Conservator confirmed excellent condition; fair value USD 6.75m.',
      'VALUATION',
      0.74,
      'doc_kl_cond',
    ),
...
const cedarRisk: RiskSummary = {
  ...
  dimensions: [
    {
      key: 'occupancy',
      label: 'Occupancy durability',
      score: 22,
      rationale: '98% leased to logistics and light manufacturing tenants.',
    },
    {
      key: 'title',
      label: 'Title & approvals',
      score: 19,
      rationale:
        'JTC industrial title and foreign ownership approval are complete.',
    },
    {
      key: 'document_coverage',
      label: 'Document coverage',
      score: 24,
      rationale: 'SPA, title, valuation and insurance are current.',
    },
  ],
};
...
const cedarDna: AssetDnaEnvelope = {
  ...
  facts: [
    fact(
      ...
      0.88,
      'doc_ce_val',
      { numericValue: 64_200_000, currency: 'SGD' },
    ),
    fact('f_ce_occ', 'occupancy', 'Occupancy', '98%', 0.9, 'doc_ce_val', {
      numericValue: 98,
      unit: '%',
    }),
    fact('f_ce_wale', 'wale', 'WALE', '6.1 years', 0.86, 'doc_ce_val', {
      numericValue: 6.1,
      unit: 'years',
    }),
    fact(
  ...
  timeline: [
    event(
      ...
      '2023-07-21',
      'Campus acquired',
      'Cedar Ridge Pte Ltd completed purchase of the Tuas industrial campus.',
      'OWNERSHIP',
      0.95,
      'doc_ce_spa',
    ),
    event(
      ...
      '2026-05-31',
      'DCF valuation',
      'Independent valuer marked the park at SGD 64.2m.',
      'VALUATION',
      0.88,
      'doc_ce_val',
    ),
  ...
  return {
    ...
    assets: [
      {
        ...
        description:
          'Class A office tower with a diversified tenant roster and 312,000 sq ft NIA.',
      ...
      },
      {
        ...
        location: 'New York',
        description:
          'Senior secured mid-market private credit commitment with quarterly NAV reporting.',
      ...
      },
      {
        ...
        description:
          '42-hectare AOC vineyard estate operated with a local wine-making partner.',
      ...
      },
      {
        ...
        description:
          '2018 Gulfstream G650ER held in an Isle of Man aviation SPV.',
      ...
      },
      {
        ...
        description:
          'Color-field canvas with gallery and exhibition provenance from 1998.',
      ...
      },
      {
        ...
        description:
          'Multi-let industrial and logistics campus with 98% occupancy.',
    ...
    ownerships: [
      {
        id: 'own_hv_1',
        assetId: harbourId,
        holderName: 'Harbourview Tower SPV Limited',
        type: 'LEGAL',
        percentage: 100,
        asOf: '2024-03-18',
      },
      {
        id: 'own_hv_2',
        assetId: harbourId,
        holderName: 'Meridian Capital Partners LLP',
        type: 'BENEFICIAL',
        percentage: 100,
        asOf: '2024-03-18',
      },
      {
        ...
        percentage: 100,
        asOf: '2023-11-02',
        notes: 'LP commitment interest',
      },
      {
        id: 'own_so_1',
        assetId: soleilId,
        holderName: 'Soleil Estate SARL',
        type: 'LEGAL',
        percentage: 100,
        asOf: '2022-09-08',
      },
      {
        id: 'own_ni_1',
        assetId: nimbusId,
        holderName: 'Nimbus Aviation IOM Ltd',
        type: 'LEGAL',
        percentage: 100,
        asOf: '2024-01-19',
      },
      {
        id: 'own_kl_1',
        assetId: klineId,
        holderName: 'Meridian Art Holdings LLC',
        type: 'LEGAL',
        percentage: 100,
        asOf: '2019-06-04',
      },
      {
        id: 'own_ce_1',
        assetId: cedarId,
        holderName: 'Cedar Ridge Pte Ltd',
        type: 'LEGAL',
        percentage: 100,
        asOf: '2023-07-21',
      },
    ...
    documents: withDocumentVersioning([
      {
        ...
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_hv_spa.txt',
        sizeBytes: hvSpaText.length,
        extractedText: hvSpaText,
      ...
      },
      {
        ...
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_hv_title.txt',
        sizeBytes: hvTitleText.length,
        extractedText: hvTitleText,
        createdAt: '2024-03-18T13:05:00.000Z',
      },
      {
        id: 'doc_hv_val',
        organizationId: orgId,
        ...
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_hv_val.txt',
        sizeBytes: hvValText.length,
        extractedText: hvValText,
      ...
      },
      {
        ...
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_hv_ins.txt',
        sizeBytes: hvInsText.length,
        extractedText: hvInsText,
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: harbourId,
        name: 'SPV KYC Pack.pdf',
        type: 'KYC',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_hv_kyc.txt',
        sizeBytes: hvKycText.length,
        extractedText: hvKycText,
      ...
      },
      {
        ...
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_au_nav.txt',
        sizeBytes: 380,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: aureliaId,
        name: 'GP KYC Summary.pdf',
        type: 'KYC',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_au_kyc.txt',
        sizeBytes: 220,
        extractedText:
          'KYC SUMMARY\nAurelia Credit Partners LP\nDomicile: Delaware\nAML status: Approved\nLast review: 12 January 2026',
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: soleilId,
        name: 'Notarial Deed — Domaine Soleil.pdf',
        type: 'TITLE_DEED',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_so_deed.txt',
        sizeBytes: 300,
        extractedText:
          'NOTARIAL DEED\nSoleil Estate SARL\nEstate size: 42 hectares\nAppellation: Saint-Émilion AOC\nLegal ownership: 100%\nAcquisition date: 8 September 2022\nPurchase price: EUR 16,900,000',
        createdAt: '2022-09-08T14:00:00.000Z',
      },
      {
        id: 'doc_so_val',
        organizationId: orgId,
        assetId: soleilId,
        name: 'Vineyard Appraisal 2026.pdf',
        type: 'VALUATION_MEMO',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_so_val.txt',
        sizeBytes: 240,
        extractedText:
          'APPRAISAL\nDomaine Soleil\nMarket value: EUR 18,600,000\nAs of: 15 May 2026\nMethod: Comparable vineyard transactions',
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: soleilId,
        name: 'Crop & Property Insurance.pdf',
        type: 'INSURANCE',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_so_ins.txt',
        sizeBytes: 180,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: nimbusId,
        name: 'Aircraft Bill of Sale.pdf',
        type: 'SPA',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ni_sale.txt',
        sizeBytes: 260,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: nimbusId,
        name: 'Aviation Residual Appraisal.pdf',
        type: 'VALUATION_MEMO',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ni_val.txt',
        sizeBytes: 240,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: nimbusId,
        name: 'Hull Insurance.pdf',
        type: 'INSURANCE',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ni_ins.txt',
        sizeBytes: 160,
        extractedText:
          'HULL INSURANCE\nInsured value: USD 33,000,000\nOperator: Nimbus Aviation IOM Ltd',
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: klineId,
        name: 'Westline Gallery Invoice.pdf',
        type: 'SPA',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_kl_invoice.txt',
        sizeBytes: 220,
        extractedText:
          'GALLERY INVOICE\nArtist: Mara Kline\nWork: Untitled (1967)\nPurchase price: USD 4,150,000\nBuyer: Meridian Art Holdings LLC\nDate: 4 June 2019',
        createdAt: '2019-06-04T14:00:00.000Z',
      },
      {
        id: 'doc_kl_cond',
        organizationId: orgId,
        assetId: klineId,
        name: 'Condition & Fair Value Report.pdf',
        type: 'VALUATION_MEMO',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_kl_cond.txt',
        sizeBytes: 200,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: klineId,
        name: 'Fine Art Insurance.pdf',
        type: 'INSURANCE',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_kl_ins.txt',
        sizeBytes: 150,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: cedarId,
        name: 'Cedar Ridge SPA.pdf',
        type: 'SPA',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ce_spa.txt',
        sizeBytes: 240,
        extractedText:
          'SALE AND PURCHASE AGREEMENT\nCedar Ridge Pte Ltd\nPurchase price: SGD 58,750,000\nDate: 21 July 2023\nLocation: Tuas, Singapore',
        createdAt: '2023-07-21T14:00:00.000Z',
      },
      {
        id: 'doc_ce_title',
        organizationId: orgId,
        assetId: cedarId,
        name: 'JTC Title Extract.pdf',
        type: 'TITLE_DEED',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ce_title.txt',
        sizeBytes: 200,
        extractedText:
          'JTC TITLE EXTRACT\nLegal ownership: 100% Cedar Ridge Pte Ltd\nProperty: Cedar Ridge Industrial Park, Tuas\nForeign ownership approval: Granted',
        createdAt: '2023-07-21T14:10:00.000Z',
      },
      {
        id: 'doc_ce_val',
        organizationId: orgId,
        assetId: cedarId,
        name: 'Industrial DCF Valuation.pdf',
        type: 'VALUATION_MEMO',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ce_val.txt',
        sizeBytes: 220,
        extractedText:
      ...
      },
      {
        ...
        organizationId: orgId,
        assetId: cedarId,
        name: 'Industrial All-Risks Policy.pdf',
        type: 'INSURANCE',
        status: 'READY',
        mimeType: 'text/plain',
        storageKey: 'seed/doc_ce_ins.txt',
        sizeBytes: 150,
        extractedText:
          'INSURANCE\nDeclared value: SGD 68,000,000\nInsured: Cedar Ridge Pte Ltd',
    ...
    portfolios: [
      ...
      },
      {
        id: 'ptf_alts',
        organizationId: orgId,
        name: 'Alternatives & Credit',
        description: 'Private credit and operating alternatives.',
        baseCurrency: 'USD',
        createdAt: '2024-04-01T09:00:00.000Z',
        updatedAt: now,
      },
      {
        ...
        description: 'Aviation, art and agricultural holdings.',
        baseCurrency: 'USD',
        createdAt: '2024-04-01T09:00:00.000Z',
        updatedAt: now,
      },
    ...
    auditEvents: [
      ...
      },
      {
        ...
        organizationId: orgId,
        actorUserId: arjunId,
        action: 'valuation.snapshot_created',
        entityType: 'Asset',
        entityId: cedarId,
    ...
    jobs: [
      ...
      },
      {
        ...
        completedAt: '2026-07-12T14:18:00.000Z',
        result: { dnaVersion: 2 },
      },
      {
        id: 'job_ce_val',
        ...
        completedAt: '2026-06-04T14:36:00.000Z',
      },
    ],
    dnaSnapshots: [
      {
    ...
    valuations: [
      {
        id: 'val_hv',
        assetId: harbourId,
        payload: harbourValuation,
        createdAt: '2026-06-30T00:00:00.000Z',
      },
      {
        id: 'val_au',
        assetId: aureliaId,
        payload: aureliaValuation,
        createdAt: '2026-06-30T00:00:00.000Z',
      },
      {
        id: 'val_so',
        assetId: soleilId,
        payload: soleilValuation,
        createdAt: '2026-05-15T00:00:00.000Z',
      },
      {
        id: 'val_ni',
        assetId: nimbusId,
        payload: nimbusValuation,
        createdAt: '2026-04-20T00:00:00.000Z',
      },
      {
        id: 'val_kl',
        assetId: klineId,
        payload: klineValuation,
        createdAt: '2026-03-12T00:00:00.000Z',
      },
      {
        id: 'val_ce',
        assetId: cedarId,
        payload: cedarValuation,
    ...
    facts: [
      {
        id: 'pf_1',
        documentId: 'doc_hv_spa',
        key: 'purchase_price',
        value: 'GBP 86,400,000',
        confidence: 0.96,
        fragment: 'Purchase price: GBP 86,400,000',
        observedAt: now,
      },
      {
        id: 'pf_2',
        documentId: 'doc_hv_val',
        key: 'market_value',
        value: 'GBP 92,800,000',
        confidence: 0.9,
        fragment: 'Market value: GBP 92,800,000',
        observedAt: now,
      },
      {
        id: 'pf_3',
        documentId: 'doc_au_nav',
        key: 'nav',
        value: 'USD 48,250,000',
        confidence: 0.9,
        fragment: 'Latest NAV: USD 48,250,000',
        observedAt: now,
      },
    ],
    copilotThreads: [
    ...
    copilotMessages: [
      {
        ...
        role: 'user',
        content:
          'What is the current value and the main risk on Harbourview Tower?',
        createdAt: '2026-07-15T09:30:00.000Z',
      },
      {
        id: 'msg_2',
    ...
    tokens: [
      {
        ...
        txHash:
          '0xdemoCedarTokenizationSepolia00000000000000000000000000000001',
        explorerUrl:
